...
/* harmony import */ var _detail_vue_vue_type_style_index_0_id_3e159eb4_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./detail.vue?vue&type=style&index=0&id=3e159eb4&lang=less&scoped=true& */ 38);
...
//
//
var musichead = function musichead() {__webpack_require__.e(/*! require.ensure | components/music-head */ "components/music-head").then((function () {return resolve(__webpack_require__(/*! @/components/music-head */ 48));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default = { components: { musichead: musichead }, data: function data() {return { isLoading: false, songDetail: { al: { picUrl: '' } }, simiSong: [], songComment: [], songLyric: [], lyricIndex: 0, playType: true };}, onLoad: function onLoad(options) {var songId = options.songId;this.initMusic(songId);}, onUnload: function onUnload() {}, onHide: function onHide() {}, methods: { initMusic: function initMusic(songId) {var _this = this;this.$store.commit('NEXT_ID', songId);Promise.all([(0, _api.songDetail)(songId), (0, _api.simiSong)(songId), (0, _api.songComment)(songId), (0, _api.songLyric)(songId), (0, _api.songUrl)(songId)]).then(function (res) {if (res[0][1].data.code == '200') {//当前播放歌曲
          ...
          _this.bgAudioManager = uni.getBackgroundAudioManager();_this.bgAudioManager.title = _this.songDetail.name;
          ...
          _this.bgAudioManager.onEnded(function () {
            _this.initMusic(_this.$store.state.nextId);
    ...
    listenLyricIndex: function listenLyricIndex() {var _this2 = this;
      ...
      this.timer = setInterval(function () {
        for (var i = 0; i < _this2.songLyric.length; i++) {
          ...
          if (_this2.bgAudioManager.currentTime + 1 > _this2.songLyric[i].time && _this2.bgAudioManager.currentTime < _this2.songLyric[i + 1].time) {
            _this2.lyricIndex = i;
          }
        }
    ...
    handleLikeSongPlay: function handleLikeSongPlay(item) {
      uni.navigateTo({
